Public Class Clients
    ...
    Private Sub ClienteBindingNavigatorSaveItem_Click(sender As Object, e As EventArgs) Handles ClienteBindingNavigatorSaveItem.Click
        ...
        Me.TableAdapterManager.UpdateAll(Me.MelodiasDataSetCliente)
    End Sub
    ...
    Private Sub Clients_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.ClienteTableAdapter.Fill(Me.MelodiasDataSetCliente.cliente)
    End Sub
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs)
        Me.ClienteTableAdapter.BuscarCliente(MelodiasDataSetCliente.cliente, BuscadorTextBox.Text)
    End Sub
